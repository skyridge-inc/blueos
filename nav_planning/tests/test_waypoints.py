...
import pytest
from nav_planning.waypoints import write_waypoints, read_waypoints


class TestWaypoints:
    def test_round_trip(self, tmp_path):
        """Write waypoints then read them back — should match."""
    ...
    def test_format_compliance(self, tmp_path):
        """Output file should start with QGC WPL 110 header."""
        ...
        # Home line: index 0, current_wp=1
    ...
    def test_custom_home(self, tmp_path):
        """Custom home position should be used instead of first waypoint."""
        wps = [(40.0, -80.0)]
        home = (39.999, -80.001)
        path = str(tmp_path / "mission.waypoints")
